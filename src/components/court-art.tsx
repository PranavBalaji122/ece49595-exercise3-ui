  ...
  return (
    ...
    >
      ...
      >
        ...
        {sport === "Basketball" ? (
          <>
            <path d="M95-35v60h130v-60M95 265v-60h130v60" />
            <path d="M65-35a95 110 0 0 0 190 0M65 265a95 110 0 0 1 190 0" />
            <circle cx="160" cy="25" r="30" />
            <circle cx="160" cy="205" r="30" />
          </>
        ) : sport === "Tennis" || sport === "Volleyball" ? (
          <>
            <path d="M75-35v300M245-35v300M75 35h170M75 185h170M160 35v150" />
            <path d="M35 106h250m-250 8h250" strokeWidth="3" />
          </>
        ) : (
          <>
            <path d="M90-35v50h140v-50M90 265v-50h140v50" />
            <path
              d="M45 45h230M45 175h230"
              strokeDasharray={sport === "Flag Football" ? "10 8" : "0"}
            />
          </>
        )}
      </g>
